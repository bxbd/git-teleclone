...
function GitTeleclone(owner, target_name, cb) { //SOON TO BE TelecloneTarget
	var self = this;
    var _cb = cb;

	if (!(this instanceof GitTeleclone)) { return new GitTeleclone(); }
...
GitTeleclone.prototype.log = function() {
...
// GitTeleclone.prototype.errout = function(msg) {
//     var caller = stackTrace.get()[1];
//     console.log( caller.getFileName() + ':' + caller.getLineNumber(), msg );
// }
//
// GitTeleclone.prototype.runcmd = _run;
// GitTeleclone.prototype.git = _git_run;
// GitTeleclone.prototype.git_current_branch = wrap('git_current_branch', function() {
...
// });
//
// GitTeleclone.prototype.git_is_tracked = wrap('git_is_tracked', function(fn) {
//    return !git('ls-files --error-unmatch -- ' + fn, true).code;
// });
//
// GitTeleclone.prototype.git_root_dir = wrap('git_root_dir', function() {
//    // return this.git('rev-parse --show-toplevel', true);
//    return this.owner.repo.path();
// }, true)

GitTeleclone.prototype._check_tree = function(sha, tree) {
    var subtree = [];
    var found;
...
GitTeleclone.prototype.git_find_blob = function(sha) {
...
GitTeleclone.prototype.git_hash = function(filename, cb) { //just the way git used to do it! (and still does)
...
exports = module.exports = GitTeleclone;
