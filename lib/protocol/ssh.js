...
GitTeleclone_ssh.prototype._do_sftp = function(cb) {
    var _this = this;
    if( !this._sftp ) {
...
GitTeleclone_ssh.prototype._readdir = function(sftp, pn, found_files, found_dirs, cb) {
    var _this = this;
...
GitTeleclone_ssh.prototype.readdir_recurse = function(pn, cb) {
    var args, cb;
...
GitTeleclone_ssh.prototype.get = function(fn, cb, args) {
    var _this = this;
    this._do_sftp(function(sftp) {
        var _t_start = new Date().getTime();
