...
function TelecloneTarget_sftp(target_name, target) {
...
TelecloneTarget_sftp.prototype._connect = function(ssh_args, args) {
    ...
    */
    ...
    var ssh = new SSH();
    this.owner._safe_call( ssh, ssh.connect, ssh_args );
...
TelecloneTarget_sftp.prototype.connect = function(args) {
